...
SET @return = (SELECT et.id FROM rbEpicrisisTemplates et WHERE et.code = '13');
...
SELECT * FROM (
SELECT @ep_ai_e:=@ep_ai_e+1, '' name, (SELECT et.name FROM rbEpicrisisTemplates et WHERE et.id = @return) description, 6 type, '' defaultValue
) tmp
