...
set @dict_OID = '1.2.643.2.69.1.1.1.150.31';
set @valueDomain = 'netricaContraception';
set @vitId = 250;
...
(0, ''1'', ''Не применялась''),
(0, ''5'', ''ВМК применялась  без осложнений''),
(0, ''2'', ''Барьерная''),
(0, ''3'', ''Прерванный половой акт''),
(0, ''4'', ''Спермициды''),
(0, ''6'', ''ВМК применялась  с осложнениями''),
(0, ''7'', ''Гормональная'');
');
 PREPARE stmt3 FROM @t1;
 EXECUTE stmt3;
