...
drop table netricaInternationalClassificationDiseasesOncology

set @dict_OID = '1.2.643.5.1.13.13.11.1060';
set @valueDomain = 'netricaWorkingConditions';
set @vitId = 461;
...
(0, ''995'', ''Световая среда (освещенность, блесткость, пульсация света)''),
(0, ''876'', ''Возбудители высоко контагиозных эпидемических заболеваний, в том числе вирусы гепатитов B и C, вирусы иммунодефицита человека''),
(0, ''982'', ''Действующие на репродукцию''),
(0, ''972'', ''Другие биологические факторы, в том числе бактериальные и иммуноферментные препараты''),
(0, ''318'', ''Перенапряжение голосового аппарата''),
(0, ''927'', ''Ультрафиолетовое излучение''),
(0, ''854'', ''Пыль животного и растительного происхождения''),
(0, ''833'', ''Физические факторы''),
(0, ''777'', ''Факторы трудового процесса''),
(0, ''775'', ''Канцерогенного действия''),
(0, ''717'', ''Ультразвук''),
(0, ''692'', ''Электромагнитные поля и излучения''),
(0, ''667'', ''Температура воздуха''),
(0, ''611'', ''Зрительные (размер объекта, работа с оптическими приборами и др.)''),
(0, ''589'', ''Тяжелый и напряженный физический труд''),
(0, ''547'', ''Аллергены''),
(0, ''542'', ''Возбудители прочих инфекционных заболеваний''),
(0, ''494'', ''Раздражающего и токсического действия''),
(0, ''462'', ''Фиброгенные и смешанные аэрозоли и пыли''),
(0, ''448'', ''Лазерное излучение''),
(0, ''442'', ''Неионизирующее излучение''),
(0, ''436'', ''Напряженность трудового процесса, связанная с высокой ответственностью и концентрацией внимания''),
(0, ''432'', ''Возбудители особо опасных инфекционных заболеваний''),
(0, ''431'', ''Химические факторы''),
(0, ''429'', ''Пылевые факторы''),
(0, ''417'', ''Тепловое излучение''),
(0, ''349'', ''Давление окружающей газовой и водной среды''),
(0, ''339'', ''Инфразвук''),
(0, ''338'', ''Биологические факторы''),
(0, ''273'', ''Ионизирующее излучение, радиоактивные вещества''),
(0, ''233'', ''Микроклимат''),
(0, ''225'', ''Акустические факторы''),
(0, ''222'', ''Движение воздуха''),
(0, ''179'', ''Нагрузка слухового анализатора''),
(0, ''122'', ''Сенсорные нагрузки''),
(0, ''114'', ''Производственная вибрация (общая, локальная)''),
(0, ''76'', ''Шум''),
(0, ''44'', ''Влажность воздуха'');
');
 PREPARE stmt3 FROM @t1;
 EXECUTE stmt3;
