...
and res.name = 'За время пребывания в ЦРБ проведены обследования' and rep.`type` != 9
...
SELECT  
  ...
  INNER JOIN ActionType at ON a.actionType_id=at.id AND at.deleted=0 AND at.class=1  AND at.title LIKE 'Анализ мочи'
  ...
  join actiontype a2 on a2.id = a.actionType_id-- and a2.name regexp 'мочи'
  where a.event_id = 6137807 and a.deleted = 0
